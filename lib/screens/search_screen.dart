    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Gap(AppLayout.getHeight(20)),
          const TicketsTabs(firstTab: "Airline Tickets", secondTab: "Hotels",),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("20% discount on business class tickets from Airline on International",
                    style: Styles.headLineStyle2.copyWith(color: Colors.grey.shade600, fontWeight: FontWeight.w500),
                    )
                  ],
                ),
              ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "Take the survey and get the discount on our services",
                              style: Styles.headLineStyle2.copyWith(
                                  color: Colors.white,
